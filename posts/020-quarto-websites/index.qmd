...
You can confirm that Quarto is installed by running `quarto --version` at the command line in the Terminal (not the R console). If a version number is returned, you're good to go.
...
If you made it this far, you have a website skeloton. Now spend some time personalizing it and adding your projects, blog posts, or whatever else. Like many hobbies, working on a website can be fun and addictive. Check out the next section for additional inspiration.
...
When in doubt, visit the GitHub page of someone else's Quarto website to see how they did it! 
 ...
 - The websites by [Emil Hvitfeldt](https://emilhvitfeldt.com/), [Meghan Hall](https://meghan.rbind.io/), [Mine Dogucu](https://www.minedogucu.com/), [Thom Mock](https://themockup.blog/about.html), and [Beatriz ZMilz](https://beamilz.com/about) offer inspiration too.
