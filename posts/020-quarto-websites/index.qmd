...
(1) We've specified that we would like to include an image from the profile_pic.jpg file in the files sub-directory. You'll need to create that sub-directory inside of your website directory and add a file with a photo. To do this at the terminal, you can use `mkdir` to create a directory and `cp` to copy.
...
When in doubt, visit the GitHub page of someone else's Quarto website to see how they did it! 
 ...
 - The websites by [Albert Rapp](https://albert-rapp.de), [Beatriz ZMilz](https://beamilz.com/about), [Chris Kenny](https://christophertkenny.com/), [Emil Hvitfeldt](https://emilhvitfeldt.com/), [Meghan Hall](https://meghan.rbind.io/), [Mine Dogucu](https://www.minedogucu.com/), [Sam Csik](https://samanthacsik.github.io), and [Tom Mock](https://themockup.blog/about.html) offer inspiration too.
