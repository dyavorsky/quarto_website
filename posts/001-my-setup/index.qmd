...
I use the pre-installed **Terminal** or the **iTerm2** terminal application with the default **zsh** shell on Mac, configured using **Oh My Zsh**.  
...
I also regularly use the **zsh-syntax-highlighting**, **zsh-completions**, and **zsh-autosuggestions** plug-ins; the **git** plug-in from Oh My Zsh; and when I'm in a vim mood, the **vi-mode** plug-in. A 3-step procedure downloads, installs, and enables most Zsh plug-ins:
