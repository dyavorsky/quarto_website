...
#### To download or update Git
 ...
 - to update on Mac: `brew upgrade git`
...
#### Tell Git who you are
 ...
 - at the terminal (mac) or command prompt or git bash (Windows) 
     ...
     - type `git config --global user.email "your email"` (must be the email you use with GitHub)
...
#### Link your GitHub account and your local Git
 ...
 - Git Credential Manager is the best way to store your GitHub credentials
    ...
    - on Mac, you can install GCM with `brew install --cask git-credential-manager`
...
Most common workflow commands
 ...
 - `git commit -m "a commit message"` to commit the staged file
